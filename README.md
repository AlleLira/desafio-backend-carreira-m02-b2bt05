...
- `Vizualizar todas as contas existentes`: È acessada através de senha do administrador para poder verificar todas as contas existentes no banco de dados.
    -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/listar-contas.jpg" width="2500" height="250"> <img loading="lazy" src="/img/listar-contas-erro.jpg.jpg" width="2500" height="250">
...
- `Cria nova conta`: Te permite criar uma nova conta par aum usuário não existente no banco de dados, caso ele já tenha uma outra conta não será possível criar uma nova, cpf e e-mail são chaves únicas.
    -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/add-conta.jpg" width="2500" height="250"> <img loading="lazy" src="/img/add-conta-erro.jpg" width="2500" height="250">

- `Atualizar dados de usuários`: Te permite altera informações de cara usuário pelo número da conta fornecida.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/atualizar-conta.jpg" width="2500" height="250"> <img loading="lazy" src="/img/atualizar-conta-erro.jpg" width="2500" height="250">

- `Excluir conta`: Te permite excluir uma conta de usuário existente contando que o saldo da conta seja 0.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/remover-conta.jpg" width="2500" height="250"> <img loading="lazy" src="/img/remover-conta-erro.jpg" width="2500" height="250">

- `Depositar`: Te permite fazer depósitos na conta informada.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/deposito.jpg" width="2500" height="250"> <img loading="lazy" src="/img/deposito-erro-1.jpg" width="2500" height="250"> <img loading="lazy" src="/img/deposito-erro.jpg" width="2500" height="250">

- `Saque`: Efetua saques do saldo da conta informada, necessário possúir senha da conta informada.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/sacar.jpg" width="2500" height="250"> <img loading="lazy" src="/img/sacar-erro.jpg" width="2500" height="250"> <img loading="lazy" src="/img/sacar-erro-1.jpg" width="2500" height="250"> <img loading="lazy" src="/img/sacar-erro-2.jpg" width="2500" height="250">
- `Transferências`: Efetua transferências entre contas, necessário possúir o número e senha da conta de origem e o número da conta de destino.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/transferir.jpg" width="2500" height="250"> <img loading="lazy" src="/img/transferir-erro.jpg" width="2500" height="250"> <img loading="lazy" src="/img/transferir-erro-1.jpg" width="2500" height="250"> <img loading="lazy" src="/img/transferir-erro-2.jpg" width="2500" height="250">

- `Saldo`: Informa o saldo existente na conta informada, necessário pussúir número e senha da conta.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/saldo.jpg" width="2500" height="250"> <img loading="lazy" src="/img/saldo-erro.jpg" width="2500" height="250"> <img loading="lazy" src="/img/saldo-erro-1.jpg" width="2500" height="250><img loading="lazy" src="/img/saldo-erro-2.jpg" width="2500" height="250">

- `Extrato bancário`: Exibe extrato de transações bancárias existente em uma conta, necessário possúir número e senha da conta.
     -`Resultasdos e Erros:`
    <img loading="lazy" src="/img/extrato.jpg" width="2500" height="250"> <img loading="lazy" src="/img/extrato-erro.jpg" width="2500" height="250"> <img loading="lazy" src="/img/extrato-erro1.jpg" width="2500" height="250"> <img loading="lazy" src="/img/extrato-erro2.jpg" width="2500" height="250">
